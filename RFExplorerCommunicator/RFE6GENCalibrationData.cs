...
{
    public class RFE6GEN_CalibrationData
    {
        //note this is shared with RFEGenTest
        readonly UInt32[] m_arrSignalGeneratorCalRanges_KHZ = {
        ...
        public int GetCalSize()
        {
            if (m_arrSignalGeneratorEmbeddedCalibrationActual30DBM != null)
                return m_arrSignalGeneratorEmbeddedCalibrationActual30DBM.Length;
            else
                return -1;
        }
        ...
        public void InitializeCal(int nSize, string sLine, out string sReport)
        {
            sReport = "";
            ...
            for (int nInd = 0; nInd < nSize; nInd++)
            {
                ...
                if (!String.IsNullOrEmpty(sLine))
                {
                    ...
                    sReport += m_arrSignalGeneratorEmbeddedCalibrationActual30DBM[nInd].ToString("00.0");
                    if (nInd < nSize - 1)
                        sReport += ",";
                }
            }
        ...
        public double[] GetEstimatedAmplitudeArray(double dFrequencyMHZ)
        {
            double[] arrReturn = null;

            if (m_arrSignalGeneratorEmbeddedCalibrationActual30DBM != null)
            {
                int nFreqInd = GetClosestFrequencyIndex(dFrequencyMHZ);
                if (nFreqInd >= 0)
                {
                    arrReturn = new double[8];
                    double dValue30DBM = m_arrSignalGeneratorEmbeddedCalibrationActual30DBM[nFreqInd];

                    arrReturn[0] = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 2];
                    arrReturn[1] = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 1];
                    arrReturn[2] = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 0];
                    arrReturn[3] = dValue30DBM;

                    arrReturn[4] = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 6];
                    arrReturn[5] = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 5];
                    arrReturn[6] = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 4];
                    arrReturn[7] = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 3];
                }
            }
        ...
        private int GetClosestFrequencyIndex(double dFrequencyMHZ)
        {
            int nFreqInd = 0;
            if (m_arrSignalGeneratorEmbeddedCalibrationActual30DBM != null)
            {
        ...
        public double GetEstimatedAmplitude(double dFrequencyMHZ, bool bHighPowerSwitch, int nPowerLevel)
        {
            double dValueDBM = 0;
            ...
            if (m_arrSignalGeneratorEmbeddedCalibrationActual30DBM != null)
            {
                dValue30DBM = m_arrSignalGeneratorEmbeddedCalibrationActual30DBM[nFreqInd];
            }
            ...
            if (bHighPowerSwitch)
            {
                switch (nPowerLevel)
                {
                    case 3: dValueDBM = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 3]; break;
                    case 2: dValueDBM = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 4]; break;
                    case 1: dValueDBM = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 5]; break;
                    case 0: dValueDBM = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 6]; break;
                }
            }
            else
            {
                switch (nPowerLevel)
                {
                    ...
                    case 2: dValueDBM = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 0]; break;
                    case 1: dValueDBM = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 1]; break;
                    case 0: dValueDBM = dValue30DBM + m_arrDeltaAmplitude[nFreqInd, 2]; break;
                }
            }
